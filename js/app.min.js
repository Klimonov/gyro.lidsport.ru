! function(e, t) {
    ...
    function h(e, t, n, r) {
        var i, o = 1,
            ...
            l = (he.cssNumber[t] || "px" !== c && +u) && Ie.exec(he.css(e, t));
        if (l && l[3] !== c) {
            c = c || l[3], n = n || [], l = +u || 1;
            do {
    ...
    function v(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++) r = e[o], r.style && (n = r.style.display, t ? ("none" === n && (i[o] = Fe.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && We(r) && (i[o] = g(r))) : "none" !== n && (i[o] = "none", Fe.set(r, "display", n)));
    ...
    function x(e, t, n, r, i) {
        for (var o, a, s, u, c, l, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++)
            ...
            for (a = a || f.appendChild(t.createElement("div")), s = (ze.exec(o) || ["", ""])[1].toLowerCase(), u = Ue[s] || Ue._default, a.innerHTML = u[1] + he.htmlPrefilter(o) + u[2], l = u[0]; l--;) a = a.lastChild;
            he.merge(p, a.childNodes), a = f.firstChild, a.textContent = ""
        } else p.push(t.createTextNode(o));
        for (f.textContent = "", d = 0; o = p[d++];)
            if (r && he.inArray(o, r) > -1) i && i.push(o);
            else if (c = he.contains(o.ownerDocument, o), a = m(f.appendChild(o), "script"), c && y(a), n)
    ...
    function D(e, t, r, i) {
        ...
        if (p && (o = x(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
            for (s = he.map(m(o, "script"), j), u = s.length; f < p; f++) c = o, f !== d && (c = he.clone(c, !0, !0), u && he.merge(s, m(c, "script"))), r.call(e[f], c, f);
            if (u)
                for (l = s[s.length - 1].ownerDocument, he.map(s, N), f = 0; f < u; f++) c = s[f], Xe.test(c.type || "") && !Fe.access(c, "globalEval") && he.contains(l, c) && (c.src ? he._evalUrl && he._evalUrl(c.src) : n(c.textContent.replace(rt, ""), l))
        }
        return e
    }

    function A(e, t, n) {
        for (var r, i = t ? he.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || he.cleanData(m(r)), r.parentNode && (n && he.contains(r.ownerDocument, r) && y(m(r, "script")), r.parentNode.removeChild(r));
        return e
    }

    function L(e, t, n) {
        var r, i, o, a, s = e.style;
        return n = n || at(e), n && (a = n.getPropertyValue(t) || n[t], "" !== a || he.contains(e.ownerDocument, e) || (a = he.style(e, t)), !pe.pixelMarginRight() && ot.test(a) && it.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    function M(e, t, n) {
        ...
        if (e.getClientRects().length && (r = e.getBoundingClientRect()[t]), r <= 0 || null == r) {
            if (r = L(e, t, o), (r < 0 || null == r) && (r = e.style[t]), ot.test(r)) return r;
    ...
    function P() {
        dt && (e.requestAnimationFrame(P), he.fx.tick())
    }
    ...
    function B(e, t, n) {
        ...
        if ((u = !he.isEmptyObject(t)) || !he.isEmptyObject(d)) {
            f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], c = m && m.display, null == c && (c = Fe.get(e, "display")), l = he.css(e, "display"), "none" === l && (c ? l = c : (v([e], !0), c = e.style.display || c, l = he.css(e, "display"), v([e]))), ("inline" === l || "inline-block" === l && null != c) && "none" === he.css(e, "float") && (u || (p.done(function() {
                h.display = c
    ...
    function Q(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = pt || I(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, a = 0, u = c.tweens.length; a < u; a++) c.tweens[a].run(o);
            ...
            l = c.props;
        for (_(l, c.opts.specialEasing); o < a; o++)
            if (r = Q.prefilters[o].call(c, e, l, c.opts)) return he.isFunction(r.stop) && (he._queueHooks(c.elem, c.opts.queue).stop = he.proxy(r.stop, r)), r;
        return he.map(l, W, c), he.isFunction(c.opts.start) && c.opts.start.call(e, c), he.fx.timer(he.extend(u, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    he.fn = he.prototype = {
        ...
        var e, t, n, r, i, o, a = arguments[0] || {},
            ...
            u = arguments.length,
            c = !1;
        for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || he.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++)
    ...
    var xe = function(e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : I) !== L && A(t), t = t || L, H)) {
                if (11 !== h && (u = ge.exec(e)))
                    if (i = u[1]) {
                        if (9 === h) {
                        ...
                        if ((i = u[3]) && b.getElementsByClassName && t.getElementsByClassName) return G.apply(n, t.getElementsByClassName(i)), n
                    }
                if (b.qsa && !Q[e + " "] && (!F || !F.test(e))) {
                    if (1 !== h) d = t, p = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(xe, be) : t.setAttribute("id", s = P), l = k(e), o = l.length; o--;) l[o] = "#" + s + " " + f(l[o]);
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, i) {
                ...
                if (u) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || a)
                            if (f = t[P] || (t[P] = {}), l = f[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
                            else {
        ...
        function v(e, t, n, i, o, a) {
            return i && !i[P] && (i = v(i)), o && !o[P] && (o = v(o, a)), r(function(r, a, s, u) {
                ...
                } else x = g(x === a ? x.splice(v, x.length) : x), o ? o(null, a, x, u) : G.apply(a, x)
            })
        }
            ...
            var i = n.length > 0,
                ...
                a = function(r, a, s, u, c) {
                    var l, f, p, d = 0,
                        ...
                        T = x.length;
                    for (c && (S = a === L || a || c); h !== T && null != (l = x[h]); h++) {
                        if (o && l) {
                            for (f = 0, a || l.ownerDocument === L || (A(l), s = !H); p = e[f++];)
                                if (p(l, a || L, s)) {
                                    u.push(l);
                                    break
                                }
        ...
        var x, b, w, T, C, k, j, N, S, E, D, A, L, q, H, F, O, M, R, P = "sizzle" + 1 * new Date,
            I = e.document,
            $ = 0,
            W = 0,
            B = n(),
        ...
        try {
            G.apply(U = Y.call(I.childNodes), I.childNodes), U[I.childNodes.length].nodeType
        } catch (e) {
            G = {
        ...
        b = t.support = {}, C = t.isXML = function(e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, q = L.documentElement, H = !C(L), I !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), b.attributes = i(function(e) {
            ...
            }), F = F.length && new RegExp(F.join("|")), O = O.length && new RegExp(O.join("|")), t = he.test(q.compareDocumentPosition), R = t || he.test(q.contains) ? function(e, t) {
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === I && R(I, e) ? -1 : t === L || t.ownerDocument === I && R(I, t) ? 1 : E ? K(E, e) - K(E, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return D = !0, 0;
                var n, r = 0,
                    i = e.parentNode,
                    ...
                    s = [e],
                    u = [t];
                if (!i || !o) return e === L ? -1 : t === L ? 1 : i ? -1 : o ? 1 : E ? K(E, e) - K(E, t) : 0;
                if (i === o) return a(e, t);
            ...
            if ((e.ownerDocument || e) !== L && A(e), n = n.replace(ue, "='$1']"), b.matchesSelector && H && !Q[n + " "] && (!O || !O.test(n)) && (!F || !F.test(n))) try {
                var r = M.call(e, n);
            ...
            var t, n = [],
                r = 0,
                i = 0;
            if (D = !b.detectDuplicates, E = !b.sortStable && e.slice(0), e.sort(z), D) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (v) {
                            ...
                            if (h = [a ? v.firstChild : v.lastChild], a && y) {
                                for (p = v, f = p[P] || (p[P] = {}), l = f[p.uniqueID] || (f[p.uniqueID] = {}), c = l[e] || [], d = c[0] === $ && c[1], x = d && c[2], p = d && v.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();)
                                    if (1 === p.nodeType && ++x && p === t) {
                                        l[e] = [$, d, x];
                                        break
                                    }
                            } else if (y && (p = t, f = p[P] || (p[P] = {}), l = f[p.uniqueID] || (f[p.uniqueID] = {}), c = l[e] || [], d = c[0] === $ && c[1], x = d), !1 === x)
                                for (;
                                    (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && (f = p[P] || (p[P] = {}), l = f[p.uniqueID] || (f[p.uniqueID] = {}), l[e] = [$, x]), p !== t)););
        ...
        return l.prototype = w.filters = w.pseudos, w.setFilters = new l, k = t.tokenize = function(e, n) {
            ...
            var n, r = [],
                ...
                o = Q[e + " "];
            if (!o) {
                for (t || (t = k(e)), n = t.length; n--;) o = m(t[n]), o[P] ? r.push(o) : i.push(o);
                o = Q(e, y(i, r)), o.selector = e
            }
            return o
            ...
            return (l || j(e, p))(r, t, !H, n, !t || ve.test(e) && c(t.parentNode) || t), n
        }, b.sortStable = P.split("").sort(z).join("") === P, b.detectDuplicates = !!D, A(), b.sortDetached = i(function(e) {
    ...
    he.Callbacks = function(e) {
                            ...
                            return function() {
                                var c = this,
                                    ...
                                    f = function() {
                                        var e, f;
                                        if (!(t < a)) {
                                            if ((e = r.apply(c, l)) === n.promise()) throw new TypeError("Thenable self-resolution");
                                            f = e && ("object" == typeof e || "function" == typeof e) && e.then, he.isFunction(f) ? i ? f.call(e, o(a, n, s, i), o(a, n, u, i)) : (a++, f.call(e, o(a, n, s, i), o(a, n, u, i), o(a, n, s, n.notifyWith))) : (r !== s && (c = void 0, l = [e]), (i || n.resolveWith)(c, l))
                                        }
                                    },
                                    p = i ? f : function() {
                                        try {
        ...
        when: function(e) {
            ...
            if (t <= 1 && (c(e, o.done(a(n)).resolve, o.reject), "pending" === o.state() || he.isFunction(i[n] && i[n].then))) return o.then();
    ...
    }), he.ready.then = Le.then, "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(he.ready) : (te.addEventListener("DOMContentLoaded", l), e.addEventListener("load", l));
    ...
    f.uid = 1, f.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t) {
                    he.isArray(t) ? t = t.map(he.camelCase) : (t = he.camelCase(t), t = t in r ? [t] : t.match(De) || []), n = t.length;
                    for (; n--;) delete r[t[n]]
    ...
    he.extend({
        ...
        queue: function(e, t, n) {
            var r;
            if (e) return t = (t || "fx") + "queue", r = Fe.get(e, t), n && (!r || he.isArray(n) ? r = Fe.access(e, t, he.makeArray(n)) : r.push(n)), r || []
        },
    ...
    he.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (v)
                for (n.handler && (o = n, n = o.handler, i = o.selector), i && he.find.matchesSelector(Je, i), n.guid || (n.guid = he.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function(t) {
                        return void 0 !== he && he.event.triggered !== t.type ? he.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(De) || [""], c = t.length; c--;) s = Ke.exec(t[c]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d && (f = he.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = he.event.special[d] || {}, l = he.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
                for (t = (t || "").match(De) || [""], c = t.length; c--;)
                    if (s = Ke.exec(t[c]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
        ...
        return this instanceof he.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? b : w, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && he.extend(this, t), this.timeStamp = e && e.timeStamp || he.now(), void(this[he.expando] = !0)) : new he.Event(e, t)
    }, he.Event.prototype = {
    ...
    he.extend({
        ...
        html: function(e) {
            return qe(this, function(e) {
                ...
                if ("string" == typeof e && !et.test(e) && !Ue[(ze.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = he.htmlPrefilter(e);
                    try {
                        for (; n < r; n++) t = this[n] || {}, 1 === t.nodeType && (he.cleanData(m(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = he.camelCase(t),
                    u = e.style;
                return t = he.cssProps[s] || (he.cssProps[s] = H(s) || s), a = he.cssHooks[t] || he.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Ie.exec(n)) && i[1] && (n = h(e, t, i), o = "number"), void(null != n && n === n && ("number" === o && (n += i && i[3] || (he.cssNumber[s] ? "" : "px")), pe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n))))
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = he.camelCase(t);
            return t = he.cssProps[s] || (he.cssProps[s] = H(s) || s), a = he.cssHooks[t] || he.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = L(e, t, r)), "normal" === i && t in ct && (i = ct[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), he.each(["height", "width"], function(e, t) {
        he.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return !st.test(he.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? M(e, t, r) : Be(e, ut, function() {
                    return M(e, t, r)
                })
            },
            set: function(e, n, r) {
                ...
                return a && (i = Ie.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = he.css(e, t)), F(e, n, a)
            }
        }
    }), he.cssHooks.marginLeft = q(pe.reliableMarginLeft, function(e, t) {
    ...
    he.Animation = he.extend(Q, {
            ...
            dt || (dt = e.requestAnimationFrame ? e.requestAnimationFrame(P) : e.setInterval(he.fx.tick, he.fx.interval))
        }, he.fx.stop = function() {
    ...
    he.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? he.prop(e, t, n) : (1 === o && he.isXMLDoc(e) || (i = he.attrHooks[t.toLowerCase()] || (he.expr.match.bool.test(t) ? vt : void 0)), void 0 !== n ? null === n ? void he.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : (r = he.find.attr(e, t), null == r ? void 0 : r))
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    he.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : he.isFunction(e) ? this.each(function(n) {
                ...
                var t, r, i, o;
                if ("string" === n)
                    for (r = 0, i = he(this), o = e.match(De) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                else void 0 !== e && "boolean" !== n || (t = X(this), t && Fe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Fe.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, r = 0;
    ...
    he.fn.extend({
        val: function(e) {
            ...
            })) : i ? (t = he.valHooks[i.type] || he.valHooks[i.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value, "string" == typeof n ? n.replace(bt, "") : null == n ? "" : n)) : void 0
        }
    }), he.extend({
        valHooks: {
            option: {
    ...
    he.extend(he.event, {
        trigger: function(t, n, r, i) {
            ...
            if (a = s = r = r || te, 3 !== r.nodeType && 8 !== r.nodeType && !wt.test(d + he.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), c = d.indexOf(":") < 0 && "on" + d, t = t[he.expando] ? t : new he.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : he.makeArray(n, [t]), f = he.event.special[d] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                ...
                for (o = 0;
                    (a = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, l = (Fe.get(a, "events") || {})[t.type] && Fe.get(a, "handle"), l && l.apply(a, n), (l = c && a[c]) && l.apply && He(a) && (t.result = l.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), n) || !He(r) || c && he.isFunction(r[d]) && !he.isWindow(r) && (s = r[c], s && (r[c] = null), he.event.triggered = d, r[d](), he.event.triggered = void 0, s && (r[c] = s)), t.result
            }
        },
    ...
    he.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !he(this).is(":disabled") && Et.test(this.nodeName) && !St.test(e) && (this.checked || !Qe.test(e))
            }).map(function(e, t) {
                var n = he(this).val();
    ...
    It.href = Tt.href, he.extend({
        ...
        ajax: function(t, n) {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = he.param(h.data, h.traditional)), J(Mt, h, n, C), l) return C;
            f = he.event && h.global, f && 0 == he.active++ && he.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ft.test(h.type), o = h.url.replace(At, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Dt, "+")) : (d = h.url.slice(o.length), h.data && (o += (kt.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(Lt, "$1"), d = (kt.test(o) ? "&" : "?") + "_=" + Ct++ + d), h.url = o + d), h.ifModified && (he.lastModified[o] && C.setRequestHeader("If-Modified-Since", he.lastModified[o]), he.etag[o] && C.setRequestHeader("If-None-Match", he.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && C.setRequestHeader("Content-Type", h.contentType), C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Pt + "; q=0.01" : "") : h.accepts["*"]);
            for (p in h.headers) C.setRequestHeader(p, h.headers[p]);
            if (h.beforeSend && (!1 === h.beforeSend.call(g, C, h) || l)) return C.abort();
            if (T = "abort", y.add(h.complete), C.done(h.success), C.fail(h.error), i = J(Rt, h, n, C)) {
    ...
    he.ajaxSetup({
        ...
        he.cssHooks[t] = q(pe.pixelPosition, function(e, n) {
    ...
    return he.noConflict = function(t) {
        return e.$ === he && (e.$ = zt), t && e.jQuery === he && (e.jQuery = Qt), he
    }, t || (e.jQuery = e.$ = he), he
    ...
    function(e, t, n) {
        ...
        i(e, "attrFn", a || {}, "jQuery.attrFn is deprecated"), e.attr = function(t, i, o, u) {
            var c = i.toLowerCase(),
                h = t && t.nodeType;
            return u && (s.length < 4 && r("jQuery.fn.attr( props, pass ) is deprecated"), t && !f.test(h) && (a ? i in a : e.isFunction(e.fn[i]))) ? e(t)[i](o) : ("type" === i && o !== n && l.test(t.nodeName) && t.parentNode && r("Can't change the 'type' of an input or button in IE 6/7/8"), !e.attrHooks[c] && p.test(c) && (e.attrHooks[c] = {
                get: function(t, r) {
                    var i, o = e.prop(t, r);
                ...
                set: function(t, n, r) {
                    var i;
                    return !1 === n ? e.removeAttr(t, r) : (i = e.propFix[r] || r, i in t && (t[i] = !0), t.setAttribute(r, r.toLowerCase())), r
                }
            }, d.test(c) && r("jQuery.fn.attr('" + c + "') might use property instead of attribute")), s.call(e, t, i, o))
        }, e.attrHooks.value = {
            get: function(e, t) {
        ...
        var C;
        for (C in m) Object.prototype.hasOwnProperty.call(m, C) && (e.find[C] = m[C]);
        ...
        e.fn.data = function(t) {
            var i, o, a = this[0];
            return !a || "events" !== t || 1 !== arguments.length || (i = e.data(a, t), o = e._data(a, t), i !== n && i !== o || o === n) ? j.apply(this, arguments) : (r("Use of jQuery.fn.data('events') is deprecated"), o)
        };
        var N = /\/(java|ecma)script/i;
        e.clean || (e.clean = function(t, n, i, o) {
            n = n || document, n = !n.nodeType && n[0] || n, n = n.ownerDocument || n, r("jQuery.clean() is deprecated");
            var a, s, u, c, l = [];
            if (e.merge(l, e.buildFragment(t, n).childNodes), i)
                for (u = function(e) {
                        return !e.type || N.test(e.type) ? o ? o.push(e.parentNode ? e.parentNode.removeChild(e) : e) : i.appendChild(e) : void 0
                    }, a = 0; null != (s = l[a]); a++) e.nodeName(s, "script") && u(s) || (i.appendChild(s), void 0 !== s.getElementsByTagName && (c = e.grep(e.merge([], s.getElementsByTagName("script")), u), l.splice.apply(l, [a + 1, 0].concat(c)), a += c.length));
            return l
        });
        var S = e.event.add,
            E = e.event.remove,
            ...
            M = /(?:^|\s)hover(\.\S+|)\b/,
            R = function(t) {
                return "string" != typeof t || e.event.special.hover ? t : (M.test(t) && r("'hover' pseudo-event is deprecated, use 'mouseenter mouseleave'"), t && t.replace(M, "mouseenter$1 mouseleave$1"))
            };
        e.event.props && "attrChange" !== e.event.props[0] && e.event.props.unshift("attrChange", "attrName", "relatedNode", "srcElement"), e.event.dispatch && i(e.event, "handle", e.event.dispatch, "jQuery.event.handle is undocumented and deprecated"), e.event.add = function(e, t, n, i, o) {
            e !== document && O.test(t) && r("AJAX events should be attached to document: " + t), S.call(this, e, R(t || ""), n, i, o)
            ...
            return n || O.test(e) || r("Global events are undocumented and deprecated"), D.call(this, e, t, n || document, i)
            ...
            e.Deferred = function(t) {
                ...
                return n.pipe = i.pipe = function() {
                    ...
                    return r("deferred.pipe() is deprecated"), e.Deferred(function(r) {
                        e.each(W, function(o, a) {
                            var s = e.isFunction(t[o]) && t[o];
                            n[a[1]](function() {
                                var t = s && s.apply(this, arguments);
                                t && e.isFunction(t.promise) ? t.promise().done(r.resolve).fail(r.reject).progress(r.notify) : r[a[0] + "With"](this === i ? r.promise() : this, s ? [t] : arguments)
                            })
                        }), t = null
                    }).promise()
        ...
        numberStepFactories: {
            ...
            separator: function(n, r, o) {
                return n = n || " ", r = r || 3, o = o || "",
                    function(a, i) {
                        var u = Math.floor(a).toString(),
                            p = e(i.elem);
                        if (u.length > r) {
                            for (var m, f, l, c = u, h = r, s = c.split("").reverse(), u = [], b = 0, v = Math.ceil(c.length / h); b < v; b++) {
                                for (m = "", l = 0; l < h && (f = b * h + l) !== c.length; l++) m += s[f];
                                u.push(m)
                            }
                            c = u.length - 1, h = t(u[c]), u[c] = t(parseInt(h, 10).toString()), u = u.join(n), u = t(u)
                        }
                        p.prop("number", a).text(u + o)
                    }
            }
        }
            ...
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, o, r) {
                        ...
                        I("ParseAjax", a), t.appendContent(e(a.data), M), n.finished = !0, B(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(m)
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var n = t.st.gallery,
                    o = ".mfp-gallery";
                return t.direction = !0, !(!n || !n.enabled) && (r += " mfp-gallery", w(d + o, function() {
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina,
                        n = e.ratio;
                    (n = isNaN(n) ? n() : n) > 1 && (w("ImageHasSize." + R, function(e, t) {
                        t.img.css({
...
! function(e) {
    ...
    e.mask = {
        ...
        mask: function(a, o) {
            var c, l, s, u, f, h;
            return !a && this.length > 0 ? (c = e(this[0]), c.data(e.mask.dataName)()) : (o = e.extend({
                placeholder: e.mask.placeholder,
                completed: null
            }, o), l = e.mask.definitions, s = [], u = h = a.length, f = null, e.each(a.split(""), function(e, t) {
                    ...
                    if (!(0 > e)) {
                        for (n = e, a = c(t); h > n; n++)
                            if (s[n]) {
                                ...
                                R[n] = R[a], R[a] = o.placeholder, a = c(a)
                            }
                ...
                function p(e) {
                    ...
                    for (t = e, n = o.placeholder; h > t; t++)
                        if (s[t]) {
                            if (a = c(t), r = R[t], R[t] = n, !(h > a && s[a].test(r))) break;
                            n = r
                        }
                }
                ...
                function g(e) {
                    var t, n, a, i = e.which;
                    8 === i || 46 === i || r && 127 === i ? (t = x.caret(), n = t.begin, a = t.end, 0 == a - n && (n = 46 !== i ? d(n) : a = c(n - 1), a = 46 === i ? c(a) : a), k(n, a), m(n, a - 1), e.preventDefault()) : 27 == i && (x.val(S), x.caret(0, y()), e.preventDefault())
                }

                function v(t) {
                    var n, a, r, l = t.which,
                        u = x.caret();
                    t.ctrlKey || t.altKey || t.metaKey || 32 > l || l && (0 != u.end - u.begin && (k(u.begin, u.end), m(u.begin, u.end - 1)), n = c(u.begin - 1), h > n && (a = String.fromCharCode(l), s[n].test(a) && (p(n), R[n] = a, b(), r = c(n), i ? setTimeout(e.proxy(e.fn.caret, x, r), 0) : x.caret(r), o.completed && r >= h && o.completed.call(x))), t.preventDefault())
                }

                function k(e, t) {
                    var n;
                    for (n = e; t > n && h > n; n++) s[n] && (R[n] = o.placeholder)
                }
                ...
                function y(e) {
                    ...
                    for (t = 0, pos = 0; h > t; t++)
                        if (s[t]) {
                            for (R[t] = o.placeholder; pos++ < a.length;)
                                if (n = a.charAt(pos - 1), s[t].test(n)) {
                                    R[t] = n, r = t;
                                    break
                                }
                            if (pos > a.length) break
                        } else R[t] === a.charAt(pos) && t !== u && (pos++, r = t);
                    return e ? b() : u > r + 1 ? (x.val(""), k(0, h)) : (b(), x.val(x.val().substring(0, r + 1))), u ? t : f
                }
                var x = e(this),
                    R = e.map(a.split(""), function(e) {
                        return "?" != e ? l[e] ? o.placeholder : e : void 0
                    }),
                    S = x.val();
                x.data(e.mask.dataName, function() {
                    return e.map(R, function(e, t) {
                        return s[t] && e != o.placeholder ? e : null
                    }).join("")
                    ...
                    clearTimeout(t);
                    var e;
                    S = x.val(), e = y(), t = setTimeout(function() {
                        b(), e == a.length ? x.caret(0, e) : x.caret(e)
                    }, 10)
                    ...
                    setTimeout(function() {
                        var e = y(!0);
                        x.caret(e), o.completed && e == x.val().length && o.completed.call(x)
                    }, 0)
                }), y()
            }))
        }
...
$(function() {
    function a(a) {
        ...
        $('.nav-link[href^="#"]').each(function() {
            var a = $(this);
            $(a.attr("href")).position().top - $(".header").innerHeight() <= e ? ($(".nav-link").removeClass("is-active"), a.addClass("is-active")) : a.removeClass("is-active")
        })
    }! function() {
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? $("html").addClass("touch-device") : $("html").addClass("no-touch-device")
    }(), $(window).on("load scroll", function(a) {
            $(window).scrollTop() > 100 ? $(".header").addClass("is-fixed") : $(".header").removeClass("is-fixed")
        }), $(".nav-mob").on("click", ".nav-mob-btn", function(a) {

            a.preventDefault(), $(this).is(".is-active") ? $(this).removeClass("is-active").closest("body").removeClass("is-navMobOpen") : $(this).addClass("is-active").closest("body").addClass("is-navMobOpen")
        }), $(".catalog-slides-container").each(function() {

            var a = $(this),
                e = a.find(".catalog-slides"),
                t = a.find(".catalog-thumbs");
            e.owlCarousel({
                items: 1,
                lazyLoad: !0,
                loop: !0,
                ...
                dotsContainer: t
            }), t.on("click", "li", function(a) {
                a.preventDefault(), e.trigger("to.owl.carousel", [$(this).index(), 300]);
                var attr = $(this).find('img').attr('alt');
                $('.popup-color').text(attr);
                $('.popup-color-input').attr({value: attr});

            })
        }), $(".catalog-tabs").on("click", "[data-tabs-btn]", function(a) {
            $("[data-tabs-btn], [data-tabs-panel]").removeClass("is-active"), $("[data-tabs-btn=" + $(this).data("tabs-btn") + "]").addClass("is-active"), $("[data-tabs-panel=" + $(this).data("tabs-btn") + "]").addClass("is-active"), $("[data-tabs-panel] [data-animation]").addClass("animated")
        }), $(".nav-mob").on("click", "[data-tabs-btn]", function(a) {
            $("body, .nav-mob-btn").removeClass("is-active is-navMobOpen"), $("html, body").stop().animate({
                scrollTop: $("#catalog").offset().top - $(".header").innerHeight()
            }, 500, "swing")
        }), $(".company-slides").owlCarousel({
            items: 1,
            lazyLoad: !0,
            loop: !0,
            margin: 10,
            ...
            autoplayTimeout: 5e3,
            autoplayHoverPause: !0,
            dotsContainer: ".company-desc-menu"
        }), $(".company-desc-menu li").on("mouseover", function(a) {
            $(".company-slides").trigger("to.owl.carousel", [$(this).index()])
            ...
            callbacks: {
                open: function() {
                    $("html").addClass("is-lockScroll"), $(".header").css({
                        "margin-right": $("html").css("margin-right")
                    })
                },
                close: function() {
                    $("html").removeClass("is-lockScroll"), $(".header").css({
                        margin: "0"
                    })
                }
            }
        }), $("[data-mfp-close]").on("click", function(a) {
            a.preventDefault(), $.magnificPopup.close()
        }), $(".js-mask-phone").mask("+7 (999) 999-99-99"), $(document).on("scroll", a), $('.nav-link[href^="#"]').on("click", function(e) {
            e.preventDefault(), $(document).off("scroll"), $('.nav-link[href^="#"]').each(function() {
            ...
            $("html, body").stop().animate({
                scrollTop: i - $(".header").innerHeight()
            }, 500, "swing", function() {
        ...
        function(a) {
            a.each(function() {
                var a = $(this),
                    e = a.data("animation"),
                    t = a.data("animation-delay"),
                    o = a.find("[data-wp-number]"),
                    i = o.data("wp-number");
                a.css({
                    "-webkit-animation-delay": t,
                    "animation-delay": t
                }), a.waypoint(function(t) {
                    "down" === t && (a.addClass(e), o.animateNumber({
                        number: i
                    }, 1e3))
                }, {
                    triggerOnce: !0,
        ...
        }($(".no-touch-device [data-animation]")), $(".faq-check-input").on("change", function(a) {
            $(this).is(":checked") ? $(".faq-check-tooltip").removeClass("is-open") : $(".faq-check-tooltip").addClass("is-open")
        }), $(".contacts-heading").on("click", function(a) {
            a.preventDefault(), $(this).closest(".contacts-desc").toggleClass("is-open")
        }), $(".quality-item").on("click", function(a) {
            a.preventDefault(), matchMedia("only screen and (max-width: 1199px)").matches && $(this).find(".quality-item-tooltip").slideToggle("fast")
        }), $(".reviews-item").on("click", function(a) {
            a.preventDefault(), matchMedia("only screen and (max-width: 1199px)").matches && $(this).toggleClass("is-open")
        }), 
        $(".catalog-info").on("click", ".catalog-info-trigger", function(a) {
            a.preventDefault(), $(this).is(".is-active") ? $(this).text("Все характеристики +").removeClass("is-active").closest(".catalog-info").removeClass("is-open") : $(this).text("Скрыть характеристики -").addClass("is-active").closest(".catalog-info").addClass("is-open")
        })
